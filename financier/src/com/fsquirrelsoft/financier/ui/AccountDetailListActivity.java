        ...
        GUIs.doBusy(this, new GUIs.BusyAdapter() {
            ...
            public void run() {
                if (target instanceof Account) {
                    ...
                    data = idp.listDetail((Tag) target, IDataProvider.LIST_DETAIL_MODE_BOTH, startDate, endDate, getContexts().getPrefMaxRecords());
                    count = idp.countDetail((Tag) target, IDataProvider.LIST_DETAIL_MODE_BOTH, startDate, endDate);
                }
            }
