...
public class Constants {
    public static final String PREFS_WORKING_BOOK_ID = "working_book_id";
    ...
    public static final String PREFS_STARTDAY_MONTH = "startday_month";
    ...
    public static final String PREFS_HIERARCHICAL_REPORT = "hierarchical_report";
    public static final String PREFS_HIDE_ZERO_ACCOUNTS = "hide_zero_accounts";
    ...
    public static final int REQUEST_TAG_EDITOR_CODE = 7;
    ...
    public static final String BACKUP_DIR = "store_path";
    public static final String PREFS_LAST_BACKUP_GOOGLE = "last_backup_google";
}
